...
if pSMU_FollowedVanillaPath.GetValueInt() > 0
  ;player followed vanilla path, give vanilla note
  Game.GetPlayer().AddItem(pRRPatriotSuicideNote)
elseif pSMU_FollowedVanillaPath.GetValueInt() == 0
  ;player followed alt path, give alt note with no mention of son
  Game.GetPlayer().AddItem(RRPatriotSuicideNoteSMUalt)
endif
...
Book Property RRPatriotSuicideNoteSMUalt Auto Const

...
;BEGIN CODE
If GetStageDone(56) == 0 && pSMU_FollowedVanillaPath.GetValueInt() > 0
...
If GetStageDone(60) == 0 && Game.GetPlayer().HasDirectLOS(Alias_SpouseCryopod.GetRef()) && pSMU_FollowedVanillaPath.GetValueInt() > 0
...
Scene Property PlayerActivateCryopods Auto Const

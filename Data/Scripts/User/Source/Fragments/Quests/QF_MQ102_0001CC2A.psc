...
;BEGIN FRAGMENT Fragment_Stage_0001_Item_02
Function Fragment_Stage_0001_Item_02()
;BEGIN AUTOCAST TYPE mq03questscript
Quest __temp = self as Quest
mq03questscript kmyQuest = __temp as mq03questscript
;END AUTOCAST
...
elseif pSMU_VaultStart.GetValueInt() == 0
  if IsObjectiveCompleted(10) == 1
...
;BEGIN FRAGMENT Fragment_Stage_0030_Item_02
Function Fragment_Stage_0030_Item_02()
;BEGIN AUTOCAST TYPE mq03questscript
Quest __temp = self as Quest
mq03questscript kmyQuest = __temp as mq03questscript
;END AUTOCAST
...
;BEGIN FRAGMENT Fragment_Stage_0055_Item_02
Function Fragment_Stage_0055_Item_02()
;BEGIN CODE
;Player reaches Concord around the museum
SetObjectiveCompleted(50, 1)
SetObjectiveDisplayed(55, 1)
...
;BEGIN FRAGMENT Fragment_Stage_0065_Item_01
Function Fragment_Stage_0065_Item_01()
;BEGIN CODE
CompleteAllObjectives()
...
;BEGIN FRAGMENT Fragment_Stage_0065_Item_02
Function Fragment_Stage_0065_Item_02()
;BEGIN CODE
CompleteAllObjectives()
